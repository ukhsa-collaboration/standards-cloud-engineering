# Contributing to UKHSA Cloud Engineering Standards

Thank you for your interest in contributing to the UKHSA Cloud Engineering Standards!

## Table of Contents

- [Contributing to UKHSA Cloud Engineering Standards][1]
  - [Table of Contents][2]
  - [Code of Conduct][3]
  - [Getting Started][4]
...
```bash
git clone https://github.com/ukhsa-collaboration/standards-cloud-engineering.git
cd standards-cloud-engineering
```

Otherwise, if you are an external contributor, you can clone your fork:

```bash
git clone https://github.com/YOUR-USERNAME/standards-cloud-engineering.git
cd standards-cloud-engineering
```
...
1. **Push your changes** to your branch/fork:
   ...
   If it's your fist push to the branch you can use:
...
After running this script you can view your docs by going to [http://localhost:8080/cloud-engineering/][44].
...
[30]: https://github.com/ukhsa-collaboration/standards-cloud-engineering/issues
...
[44]: http://localhost:8080/cloud-engineering/
